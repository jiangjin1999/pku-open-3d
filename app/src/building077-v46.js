/* Langrunyuan 8: four documented storeys, original eaves and footprint.
...
const A=Y.Architecture30,previous=A.render,ID='way/873446764';
A.render=function(b,f,add){
 ...
 [[q[0],q[1],a],[q[1],q[2],c,a],[q[2],q[3],c],[q[3],q[0],a,c]].forEach((points,i)=>{
  ...
  add('077-roof-'+i,g,color,material,f.properties.pickId);
 });
 return {...result,strategy:'building077-v46',roof:'hip-planar-edge-intersections'};
};
})(YY);
